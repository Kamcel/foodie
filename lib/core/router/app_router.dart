...
final GoRouter router = GoRouter(
  initialLocation: Routes.restaurantScreen,
  redirect: (context, state) {
    ...
    // Special redirect for the demo screen to bypass auth if logged in, but not for other non-auth screens
    //if (isLoggedIn && location == Routes.restaurantCardDemo) return null;

    if (isLoggedIn && !isOnAuthScreen) return Routes.login;
    return null;
  },
  routes: [
    GoRoute(
