...
// F -- Fields
  ...
  @override
  String toString() {
    return 'Review(id: $id, userId: $userId, userName: $userName, userAvatar: $userAvatar, comment: $comment, createdAt: $createdAt, rating: $rating)';
  }
}
...
extension ReviewPatterns on Review {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Review() when $default != null:
        return $default(_that.id, _that.userId, _that.userName,
            _that.userAvatar, _that.comment, _that.createdAt, _that.rating);
      case _:
        return orElse();
    }
  }
