...
// F -- Fields
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, userName, avatarPath);

  @override
  String toString() {
    return 'UpdateUserRequest(name: $name, userName: $userName, avatarPath: $avatarPath)';
  }
}
...
abstract mixin class $UpdateUserRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String userName, String avatarPath});
}
...
extension UpdateUserRequestPatterns on UpdateUserRequest {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String userName, String avatarPath)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UpdateUserRequest() when $default != null:
        return $default(_that.name, _that.userName, _that.avatarPath);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String name, String userName, String avatarPath) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _UpdateUserRequest():
...
class _UpdateUserRequest extends UpdateUserRequest {
  const _UpdateUserRequest(
      {required this.name, required this.userName, required this.avatarPath})
      : super._();
